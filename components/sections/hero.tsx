      ...
      <Container className="relative z-10 flex flex-col items-center text-center">
        ...
        >
          <motion.div variants={fadeIn} className="flex items-center gap-3">
            <Badge className="bg-card/50 backdrop-blur border-border text-muted-foreground">
            ...
            <Badge className="bg-transparent border-transparent text-muted-foreground flex items-center gap-1">
          ...
          <motion.div variants={fadeIn} className="space-y-4">
            <Text className="text-muted-foreground tracking-widest uppercase text-sm font-mono font-semibold">
              Ankith Binagekar
            </Text>
            <H1 className="text-5xl md:text-7xl font-bold tracking-tighter leading-tight bg-clip-text text-transparent bg-gradient-to-b from-foreground to-foreground/60">
